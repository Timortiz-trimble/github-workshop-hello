# GitHub workshop — Hello World

This is a **practice garage** for people who are new to Git and GitHub.

You will not break anything important here. The only job is to practice the loop:
...
1. You need a GitHub account. Sign in to [github.com](https://github.com) first.
2. In Cursor: **File → Clone Repo** (or the GitHub / Source Control clone option).
3. Paste this URL:

```
https://github.com/Timortiz-trimble/github-workshop-hello
```

4. Pick a folder on your computer and open the cloned project.
...
After Cursor shows your commit as pushed:

1. Open this repo in a browser: https://github.com/Timortiz-trimble/github-workshop-hello
2. GitHub usually offers **Compare & pull request**.
...
Skip the terminal, `git` command line, personal access tokens, and merging other people’s pull requests. Facilitators will merge later.
